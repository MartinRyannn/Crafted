...
const Container1 = () => {
  ...
  const scrollToNext = () => {
    const nextContainer = document.querySelector('.container-white');
      ...
      <div className="coverScreen">
        ...
        <div className="jumpBtn fade-in-up" onClick={scrollToNext}>
          <svg width="140" height="140" className="dashed-circle">
            <circle cx="70" cy="70" r="69" fill="none" stroke="rgba(255, 255, 255, 0.507)" strokeWidth="1.5" strokeDasharray="10,10"/>
          </svg>
